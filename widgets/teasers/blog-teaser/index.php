<?php
class Eperi_Blog_Teaser_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Blog teaser', 'elementor-addon');
    }
...
?>
        ...
        <div style="background-color:red; color:white; display:inline; padding:0px 5px">Blog Teaser</div>
